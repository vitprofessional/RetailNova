...
class BrandPolicy
{
    ...
    public function delete(User|AdminUser|null $user, Brand $brand): bool { return $user && in_array($user->role,['admin','superadmin']); }
    public function forceDelete(User|AdminUser|null $user, Brand $brand): bool { return $user && $user->role==='superadmin'; }
}
