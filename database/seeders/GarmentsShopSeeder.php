...
class GarmentsShopSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── Customers ────────────────────────────────────────────────────────
        $customers = [
            ['name' => 'Fashion Hub Retail',  'mail' => 'fashionhub@retail.com',    'mobile' => '0325-1201001', 'country' => 'Bangladesh', 'state' => 'Dhaka',      'city' => 'Dhaka',      'area' => 'Dhanmondi',  'openingBalance' => 0,    'businessId' => 1],
            ['name' => 'Style Zone Shop',     'mail' => 'stylezone@shop.com',       'mobile' => '0325-1202002', 'country' => 'Bangladesh', 'state' => 'Dhaka',      'city' => 'Dhaka',      'area' => 'Gulshan',    'openingBalance' => 6000, 'businessId' => 1],
            ['name' => 'Trend Wear Store',    'mail' => 'trendwear@store.com',      'mobile' => '0325-1203003', 'country' => 'Bangladesh', 'state' => 'Chattogram', 'city' => 'Chattogram', 'area' => 'Nasirabad',  'openingBalance' => 0,    'businessId' => 1],
            ['name' => 'Layla Fashion',       'mail' => 'layla.fashion@email.com',  'mobile' => '0325-1204004', 'country' => 'Bangladesh', 'state' => 'Sylhet',     'city' => 'Sylhet',     'area' => 'Bondor',     'openingBalance' => 2500, 'businessId' => 1],
            ['name' => 'Modern Boutique',     'mail' => 'modern.boutique@email.com','mobile' => '0325-1205005', 'country' => 'Bangladesh', 'state' => 'Rajshahi',   'city' => 'Rajshahi',   'area' => 'New Market', 'openingBalance' => 0,    'businessId' => 1],
        ];
        ...
        // ── Products ─────────────────────────────────────────────────────────
        $products = [
            ['name' => "Men's Formal Shirt White (L)",     'brand' => $brand('Cotton Comfort'), 'category' => $cat("Men's Wear"),          'unitName' => $unit('Piece'), 'quantity' => '10', 'details' => '100% Cotton Formal Dress Shirt White Size L',                  'barCode' => 'MS-FRM-WHT-L-001',  'businessId' => 1, 'stock' => 50,  'buy' =>  350, 'sell' =>  650],
            ['name' => "Men's Formal Shirt Blue (L)",      'brand' => $brand('Cotton Comfort'), 'category' => $cat("Men's Wear"),          'unitName' => $unit('Piece'), 'quantity' => '10', 'details' => '100% Cotton Formal Dress Shirt Sky Blue Size L',               'barCode' => 'MS-FRM-BLU-L-001',  'businessId' => 1, 'stock' => 45,  'buy' =>  350, 'sell' =>  650],
            ['name' => "Men's Casual Polo T-Shirt (M)",    'brand' => $brand('FashionWear'),    'category' => $cat("Men's Wear"),          'unitName' => $unit('Piece'), 'quantity' => '10', 'details' => 'Pique Cotton Polo T-Shirt Short Sleeve Size M',                 'barCode' => 'MS-PLO-M-001',      'businessId' => 1, 'stock' => 60,  'buy' =>  250, 'sell' =>  480],
            ['name' => 'Denim Jeans Men 32"',              'brand' => $brand('Classic Cotton'), 'category' => $cat("Men's Wear"),          'unitName' => $unit('Piece'), 'quantity' => '5',  'details' => 'Slim Fit Stretch Denim Jeans Waist 32 Inches',                  'barCode' => 'DN-JNS-32-001',     'businessId' => 1, 'stock' => 40,  'buy' =>  600, 'sell' => 1100],
            ["name" => "Women's Salwar Kameez Set (M)",    'brand' => $brand('Linen House'),    'category' => $cat("Women's Wear"),        'unitName' => $unit('Set'),   'quantity' => '10', 'details' => 'Printed Salwar Kameez 3-Piece Set Cotton Blend Size M',          'barCode' => 'WS-SK-M-001',       'businessId' => 1, 'stock' => 50,  'buy' =>  500, 'sell' =>  950],
            ['name' => 'Ladies Printed Kurti (L)',         'brand' => $brand('FashionWear'),    'category' => $cat("Women's Wear"),        'unitName' => $unit('Piece'), 'quantity' => '10', 'details' => 'Floral Block Print Kurti Knee Length Cotton Size L',             'barCode' => 'WS-KRT-L-001',      'businessId' => 1, 'stock' => 55,  'buy' =>  350, 'sell' =>  680],
            ['name' => 'Kids Cotton T-Shirt (Age 5-6)',    'brand' => $brand('Cotton Comfort'), 'category' => $cat("Kids Wear"),           'unitName' => $unit('Piece'), 'quantity' => '20', 'details' => '100% Soft Cotton Kids T-Shirt Age 5-6 Years Assorted Colors',   'barCode' => 'KT-CTN-56-001',     'businessId' => 1, 'stock' => 80,  'buy' =>  150, 'sell' =>  300],
            ['name' => 'Boys School Pants (Age 8-10)',     'brand' => $brand('Classic Cotton'), 'category' => $cat("Kids Wear"),           'unitName' => $unit('Piece'), 'quantity' => '15', 'details' => 'Dark Navy School Uniform Pants Age 8-10 Years',                 'barCode' => 'KB-PANT-810-001',   'businessId' => 1, 'stock' => 60,  'buy' =>  250, 'sell' =>  500],
            ['name' => 'Traditional Panjabi (L)',          'brand' => $brand('Dhaka Textile'),  'category' => $cat("Traditional Wear"),    'unitName' => $unit('Piece'), 'quantity' => '10', 'details' => 'Premium Cotton Embroidered Panjabi Eid/Festival Size L',         'barCode' => 'TR-PNJ-L-001',      'businessId' => 1, 'stock' => 35,  'buy' =>  400, 'sell' =>  750],
            ['name' => 'Cotton Fabric per Yard',           'brand' => $brand('Dhaka Textile'),  'category' => $cat("Fabric & Cloth"),      'unitName' => $unit('Yard'),  'quantity' => '50', 'details' => '40-count Woven Cotton Fabric 44" Width Per Yard',               'barCode' => 'FAB-CTN-YD-001',    'businessId' => 1, 'stock' => 500, 'buy' =>   80, 'sell' =>  150],
            ['name' => 'Premium Silk Fabric per Yard',     'brand' => $brand('Premium Fabric'), 'category' => $cat("Fabric & Cloth"),      'unitName' => $unit('Yard'),  'quantity' => '20', 'details' => 'Pure Mulberry Silk Fabric 44" Width Smooth Finish Per Yard',    'barCode' => 'FAB-SLK-YD-001',    'businessId' => 1, 'stock' => 200, 'buy' =>  350, 'sell' =>  650],
            ["name" => "Men's Undergarment Set",           'brand' => $brand('Cotton Comfort'), 'category' => $cat("Undergarments"),       'unitName' => $unit('Set'),   'quantity' => '20', 'details' => "Men's 100% Cotton Boxer + Vest Combo Set Free Size",             'barCode' => 'UG-MEN-SET-001',    'businessId' => 1, 'stock' => 70,  'buy' =>  150, 'sell' =>  350],
        ];
        ...
        $purchases = [
            [
                ...
                'specialNote' => 'White formal shirts initial stock', 'businessId' => 1,
            ],
            [
                ...
                'specialNote' => 'Salwar kameez sets – partial payment', 'businessId' => 1,
            ],
            [
                ...
                'specialNote' => 'Cotton fabric bulk lot', 'businessId' => 1,
            ],
            [
                ...
                'specialNote' => 'Traditional Panjabi stock for Eid', 'businessId' => 1,
            ],
            [
                ...
                'specialNote' => 'Denim jeans stock', 'businessId' => 1,
            ],
        ];
        ...
        $sales = [
            ...
            [
                'header' => [
                    ...
                    'prevDue' => '6000', 'curDue' => '6000', 'status' => 'complete', 'businessId' => 1,
                ],
                'items' => [
            ...
            [
                'header' => [
                    ...
                    'prevDue' => '0', 'curDue' => '4500', 'status' => 'partial', 'businessId' => 1,
                ],
                'items' => [[
            ...
            [
                'header' => [
                    ...
                    'prevDue' => '2500', 'curDue' => '2500', 'status' => 'complete', 'businessId' => 1,
                ],
                'items' => [
            ...
            [
                'header' => [
                    ...
                    'prevDue' => '0', 'curDue' => '8800', 'status' => 'due', 'businessId' => 1,
                ],
                'items' => [[
