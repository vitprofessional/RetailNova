...
class VehicleShopSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── Customers ────────────────────────────────────────────────────────
        $customers = [
            ['name' => 'Karim Auto Workshop', 'mail' => 'karim.auto@email.com',      'mobile' => '0322-5001001', 'country' => 'Bangladesh', 'state' => 'Dhaka',      'city' => 'Dhaka',      'area' => 'Badda',       'openingBalance' => 0,    'businessId' => 1],
            ['name' => 'Ali Motors Garage',   'mail' => 'ali.motors@email.com',      'mobile' => '0322-5002002', 'country' => 'Bangladesh', 'state' => 'Dhaka',      'city' => 'Dhaka',      'area' => 'Demra',       'openingBalance' => 5000, 'businessId' => 1],
            ['name' => 'Bike Care Center',    'mail' => 'bikecare.center@email.com', 'mobile' => '0322-5003003', 'country' => 'Bangladesh', 'state' => 'Chattogram', 'city' => 'Chattogram', 'area' => 'Fatikchhari', 'openingBalance' => 0,    'businessId' => 1],
            ['name' => 'Malik Transport Co',  'mail' => 'malik.transport@email.com', 'mobile' => '0322-5004004', 'country' => 'Bangladesh', 'state' => 'Rajshahi',   'city' => 'Rajshahi',   'area' => 'Rajpara',     'openingBalance' => 2500, 'businessId' => 1],
            ['name' => 'Noor Vehicles BD',    'mail' => 'noor.vehicles@email.com',   'mobile' => '0322-5005005', 'country' => 'Bangladesh', 'state' => 'Khulna',     'city' => 'Khulna',     'area' => 'Batiaghata',  'openingBalance' => 0,    'businessId' => 1],
        ];
        ...
        // ── Products ─────────────────────────────────────────────────────────
        $products = [
            ['name' => 'NGK Spark Plug BPR6ES',          'brand' => $brand('NGK'),     'category' => $cat('Engine Parts'),        'unitName' => $unit('Piece'), 'quantity' => '20', 'details' => 'Standard Resistor Spark Plug for most 4-stroke engines',     'barCode' => 'NGK-BPR6ES-001',    'businessId' => 1, 'stock' => 60, 'buy' =>  350,  'sell' =>  600],
            ['name' => 'Bosch Wiper Blade A26F',          'brand' => $brand('Bosch'),   'category' => $cat('Body & Exterior'),     'unitName' => $unit('Piece'), 'quantity' => '10', 'details' => '26" Aerotwin Front Wiper Blade',                              'barCode' => 'BSH-WPR-A26F-001',  'businessId' => 1, 'stock' => 40, 'buy' =>  600,  'sell' => 1000],
            ['name' => 'Honda CD70 Chain Sprocket Kit',   'brand' => $brand('Honda'),   'category' => $cat('Engine Parts'),        'unitName' => $unit('Set'),   'quantity' => '10', 'details' => 'Chain + Front & Rear Sprocket for Honda CD70',               'barCode' => 'HON-CD70-CSK-001',  'businessId' => 1, 'stock' => 35, 'buy' =>  800,  'sell' => 1400],
            ['name' => 'Yamaha FZS Clutch Cable',         'brand' => $brand('Yamaha'),  'category' => $cat('Engine Parts'),        'unitName' => $unit('Piece'), 'quantity' => '15', 'details' => 'Original Clutch Cable for Yamaha FZS Series',                'barCode' => 'YAM-FZS-CC-001',    'businessId' => 1, 'stock' => 50, 'buy' =>  250,  'sell' =>  450],
            ['name' => 'Bajaj Pulsar 150 Brake Pad Set',  'brand' => $brand('Bajaj'),   'category' => $cat('Suspension & Brakes'), 'unitName' => $unit('Set'),   'quantity' => '10', 'details' => 'Front & Rear Brake Pad Set for Bajaj Pulsar 150',            'barCode' => 'BAJ-P150-BPS-001',  'businessId' => 1, 'stock' => 40, 'buy' =>  500,  'sell' =>  850],
            ['name' => 'Castrol Engine Oil 5W-30 4L',     'brand' => $brand('Castrol'), 'category' => $cat('Lubricants & Fluids'), 'unitName' => $unit('Piece'), 'quantity' => '10', 'details' => 'Fully Synthetic Engine Oil 5W-30, 4 Litre Can',              'barCode' => 'CST-5W30-4L-001',   'businessId' => 1, 'stock' => 30, 'buy' =>  900,  'sell' => 1400],
            ['name' => 'Toyota Corolla Air Filter',       'brand' => $brand('Toyota'),  'category' => $cat('Filters'),             'unitName' => $unit('Piece'), 'quantity' => '10', 'details' => 'OEM Air Filter for Toyota Corolla 2014-2020',                'barCode' => 'TOY-COR-AF-001',    'businessId' => 1, 'stock' => 45, 'buy' =>  450,  'sell' =>  750],
            ['name' => '12V 65Ah Dry Cell Battery',       'brand' => $brand('Generic'), 'category' => $cat('Batteries'),           'unitName' => $unit('Piece'), 'quantity' => '3',  'details' => 'Maintenance-Free Dry Battery for Cars 12V 65Ah',             'barCode' => 'BAT-12V-65AH-001',  'businessId' => 1, 'stock' => 15, 'buy' => 6000,  'sell' => 8500],
            ['name' => 'Car Tyre 185/65R15',              'brand' => $brand('Generic'), 'category' => $cat('Tyres & Tubes'),       'unitName' => $unit('Piece'), 'quantity' => '4',  'details' => '185/65R15 88H All-Season Passenger Car Tyre',                'barCode' => 'TYR-185-65R15-001', 'businessId' => 1, 'stock' => 20, 'buy' => 4500,  'sell' => 6500],
            ['name' => 'Radiator Coolant 1L (Universal)', 'brand' => $brand('Generic'), 'category' => $cat('Lubricants & Fluids'), 'unitName' => $unit('Piece'), 'quantity' => '15', 'details' => 'Long-Life Radiator Coolant & Antifreeze 1 Litre',            'barCode' => 'RAD-COOL-1L-001',   'businessId' => 1, 'stock' => 50, 'buy' =>  200,  'sell' =>  380],
            ['name' => 'Headlight Bulb H4 60/55W Pair',   'brand' => $brand('Bosch'),   'category' => $cat('Electrical Parts'),    'unitName' => $unit('Pair'),  'quantity' => '20', 'details' => 'H4 Halogen Headlight Bulb 60/55W Twin Pack',                 'barCode' => 'HLB-H4-PAIR-001',   'businessId' => 1, 'stock' => 60, 'buy' =>  280,  'sell' =>  500],
            ['name' => 'Motorcycle Helmet Half Face',      'brand' => $brand('Generic'), 'category' => $cat('Body & Exterior'),     'unitName' => $unit('Piece'), 'quantity' => '5',  'details' => 'DOT-Certified Half Face Motorcycle Helmet',                   'barCode' => 'HLM-HF-001',        'businessId' => 1, 'stock' => 25, 'buy' => 1200,  'sell' => 2000],
        ];
        ...
        $purchases = [
            [
                ...
                'specialNote' => 'NGK Spark Plug initial lot', 'businessId' => 1,
            ],
            [
                ...
                'specialNote' => 'Car batteries – partial payment', 'businessId' => 1,
            ],
            [
                ...
                'specialNote' => 'Car tyre stock', 'businessId' => 1,
            ],
            [
                ...
                'specialNote' => 'Castrol engine oil batch', 'businessId' => 1,
            ],
            [
                ...
                'specialNote' => 'Honda CD70 chain sprocket kits', 'businessId' => 1,
            ],
        ];
        ...
        $sales = [
            ...
            [
                'header' => [
                    ...
                    'prevDue' => '5000', 'curDue' => '5000', 'status' => 'complete', 'businessId' => 1,
                ],
                'items' => [
            ...
            [
                'header' => [
                    ...
                    'prevDue' => '0', 'curDue' => '3000', 'status' => 'partial', 'businessId' => 1,
                ],
                'items' => [[
            ...
            [
                'header' => [
                    ...
                    'prevDue' => '0', 'curDue' => '3500', 'status' => 'due', 'businessId' => 1,
                ],
                'items' => [
