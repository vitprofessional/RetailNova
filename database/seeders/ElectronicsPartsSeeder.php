...
class ElectronicsPartsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── Customers ────────────────────────────────────────────────────────
        $customers = [
            ['name' => 'Robotics Lab BD',        'mail' => 'robotics@labbd.com',        'mobile' => '0324-9001001', 'country' => 'Bangladesh', 'state' => 'Dhaka',    'city' => 'Dhaka',    'area' => 'BUET Campus',  'openingBalance' => 0,    'businessId' => 1],
            ['name' => 'Engineering Projects Co', 'mail' => 'eng@projectsco.com',        'mobile' => '0324-9002002', 'country' => 'Bangladesh', 'state' => 'Dhaka',    'city' => 'Dhaka',    'area' => 'Mohakhali',   'openingBalance' => 1500, 'businessId' => 1],
            ['name' => 'Makers Workshop',         'mail' => 'makers@workshop.com',       'mobile' => '0324-9003003', 'country' => 'Bangladesh', 'state' => 'Dhaka',    'city' => 'Dhaka',    'area' => 'Lalmatia',    'openingBalance' => 0,    'businessId' => 1],
            ['name' => 'PCB Design Studio',       'mail' => 'pcbdesign@studio.com',      'mobile' => '0324-9004004', 'country' => 'Bangladesh', 'state' => 'Sylhet',   'city' => 'Sylhet',   'area' => 'Tilagarh',    'openingBalance' => 800,  'businessId' => 1],
            ['name' => 'Automation Tech BD',      'mail' => 'automation@techbd.com',     'mobile' => '0324-9005005', 'country' => 'Bangladesh', 'state' => 'Rajshahi', 'city' => 'Rajshahi', 'area' => 'Laxmipur',    'openingBalance' => 0,    'businessId' => 1],
        ];
        ...
        // ── Products ─────────────────────────────────────────────────────────
        $products = [
            ['name' => 'Arduino Uno R3',                'brand' => $brand('Arduino'),            'category' => $cat('Microcontrollers & Dev Boards'), 'unitName' => $unit('Piece'), 'quantity' => '5',  'details' => 'ATmega328P, 14 Digital I/O, 6 Analog Inputs, USB-A',       'barCode' => 'ARD-UNO-R3-001',     'businessId' => 1, 'stock' => 40,  'buy' =>  750, 'sell' => 1200],
            ['name' => 'Raspberry Pi 4 Model B 4GB',    'brand' => $brand('Raspberry Pi'),       'category' => $cat('Microcontrollers & Dev Boards'), 'unitName' => $unit('Piece'), 'quantity' => '3',  'details' => 'Quad-core Cortex-A72, 4GB RAM, Wi-Fi, Bluetooth, USB 3.0', 'barCode' => 'RPI-4B-4G-001',      'businessId' => 1, 'stock' => 15,  'buy' => 5000, 'sell' => 7000],
            ['name' => '555 Timer IC NE555P (Pack 10)', 'brand' => $brand('Texas Instruments'),  'category' => $cat('Active Components'),             'unitName' => $unit('Box'),   'quantity' => '50', 'details' => 'NE555P Timer IC Pack of 10 – General Purpose',             'barCode' => 'IC-NE555-P10-001',   'businessId' => 1, 'stock' => 200, 'buy' =>   40, 'sell' =>  100],
            ['name' => '10KΩ Resistor 1/4W (Pack 100)', 'brand' => $brand('Generic'),            'category' => $cat('Passive Components'),            'unitName' => $unit('Box'),   'quantity' => '50', 'details' => '10K Ohm Through-hole Resistor 1/4W 5% Tolerance Pack 100', 'barCode' => 'RES-10K-P100-001',   'businessId' => 1, 'stock' => 300, 'buy' =>   30, 'sell' =>   80],
            ['name' => '100µF 25V Capacitor (Pack 20)', 'brand' => $brand('Generic'),            'category' => $cat('Passive Components'),            'unitName' => $unit('Box'),   'quantity' => '30', 'details' => '100 µF 25V Electrolytic Capacitor Pack of 20',             'barCode' => 'CAP-100UF-P20-001',  'businessId' => 1, 'stock' => 200, 'buy' =>   40, 'sell' =>  100],
            ['name' => 'BC547 NPN Transistor (Pack 50)','brand' => $brand('STMicroelectronics'), 'category' => $cat('Active Components'),             'unitName' => $unit('Box'),   'quantity' => '30', 'details' => 'BC547B NPN General Purpose Transistor Pack of 50',          'barCode' => 'TRN-BC547-P50-001',  'businessId' => 1, 'stock' => 200, 'buy' =>   50, 'sell' =>  120],
            ['name' => 'LED 5mm Red (Pack 100)',         'brand' => $brand('Philips'),            'category' => $cat('Active Components'),             'unitName' => $unit('Box'),   'quantity' => '50', 'details' => '5mm Through-Hole Red LED 30mA Pack of 100',                'barCode' => 'LED-5MM-RED-001',    'businessId' => 1, 'stock' => 300, 'buy' =>   80, 'sell' =>  200],
            ['name' => '60W Soldering Iron Station',    'brand' => $brand('JBC Tools'),          'category' => $cat('Tools & Equipment'),             'unitName' => $unit('Piece'), 'quantity' => '2',  'details' => '60W Digital Soldering Station with Lead-Free Tips',         'barCode' => 'SOL-60W-STN-001',    'businessId' => 1, 'stock' => 10,  'buy' => 1500, 'sell' => 2500],
            ['name' => 'Digital Multimeter Auto-Range', 'brand' => $brand('Generic'),            'category' => $cat('Tools & Equipment'),             'unitName' => $unit('Piece'), 'quantity' => '3',  'details' => 'Auto-Ranging DMM, DC/AC Voltage, Current, Resistance, Diode','barCode' => 'DMM-AUTO-001',        'businessId' => 1, 'stock' => 20,  'buy' =>  800, 'sell' => 1400],
            ['name' => 'Breadboard 830 Points',         'brand' => $brand('Generic'),            'category' => $cat('PCB & Prototyping'),             'unitName' => $unit('Piece'), 'quantity' => '10', 'details' => '830 Tie-Point Solderless Breadboard with Power Rails',       'barCode' => 'BBD-830-001',        'businessId' => 1, 'stock' => 80,  'buy' =>  200, 'sell' =>  420],
            ['name' => '40-Pin Jumper Wires M-M 20cm',  'brand' => $brand('Generic'),            'category' => $cat('Wires & Connectors'),            'unitName' => $unit('Box'),   'quantity' => '20', 'details' => '40-Pin Male-to-Male Breadboard Jumper Wires 20cm',          'barCode' => 'JMP-40PIN-001',      'businessId' => 1, 'stock' => 150, 'buy' =>   80, 'sell' =>  180],
            ['name' => '5V 2A DC Power Supply Module',  'brand' => $brand('Generic'),            'category' => $cat('Power Electronics'),             'unitName' => $unit('Piece'), 'quantity' => '10', 'details' => 'AC-DC 5V 2A Regulated Switch Mode Power Supply Module',      'barCode' => 'PSM-5V2A-001',       'businessId' => 1, 'stock' => 50,  'buy' =>  120, 'sell' =>  280],
        ];
        ...
        $purchases = [
            [
                ...
                'specialNote' => 'Arduino Uno R3 initial stock', 'businessId' => 1,
            ],
            [
                ...
                'specialNote' => 'Raspberry Pi 4 batch', 'businessId' => 1,
            ],
            [
                ...
                'specialNote' => 'Soldering stations – partial payment', 'businessId' => 1,
            ],
            [
                ...
                'specialNote' => 'Resistor bulk lot', 'businessId' => 1,
            ],
            [
                ...
                'specialNote' => 'Digital multimeters batch', 'businessId' => 1,
            ],
        ];
        ...
        $sales = [
            ...
            [
                'header' => [
                    ...
                    'prevDue' => '1500', 'curDue' => '5000', 'status' => 'partial', 'businessId' => 1,
                ],
                'items' => [
            ...
            [
                'header' => [
                    ...
                    'prevDue' => '800', 'curDue' => '800', 'status' => 'complete', 'businessId' => 1,
                ],
                'items' => [
                    ['purchaseId' => $purId('PUR-ELC-003'), 'qty' => 1, 'salePrice' => '2500', 'buyPrice' => '1500', 'totalSale' => '2500', 'totalPurchase' => '1500', 'profitTotal' => '1000', 'profitMargin' => '40.00', 'warranty_days' => '365'],
                    ['purchaseId' => $purId('PUR-ELC-005'), 'qty' => 2, 'salePrice' => '1400', 'buyPrice' => '800',  'totalSale' => '2800', 'totalPurchase' => '1600', 'profitTotal' => '1200', 'profitMargin' => '42.86', 'warranty_days' => '365'],
            ...
            [
                'header' => [
                    ...
                    'prevDue' => '0', 'curDue' => '12000', 'status' => 'due', 'businessId' => 1,
                ],
                'items' => [[
