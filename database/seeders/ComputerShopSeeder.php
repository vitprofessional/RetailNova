...
class ComputerShopSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // ── Customers ────────────────────────────────────────────────────────
        $customers = [
            ['name' => 'CyberZone Computer',  'mail' => 'cyberzone@computer.com',    'mobile' => '0323-7001001', 'country' => 'Bangladesh', 'state' => 'Dhaka',      'city' => 'Dhaka',      'area' => 'Elephant Road', 'openingBalance' => 0,     'businessId' => $bid],
            ['name' => 'Pixel Tech Shop',     'mail' => 'pixeltech@shop.com',        'mobile' => '0323-7002002', 'country' => 'Bangladesh', 'state' => 'Dhaka',      'city' => 'Dhaka',      'area' => 'Panthapath',    'openingBalance' => 7500,  'businessId' => $bid],
            ['name' => 'DataSoft Solutions',  'mail' => 'datasoft@solutions.com',    'mobile' => '0323-7003003', 'country' => 'Bangladesh', 'state' => 'Dhaka',      'city' => 'Dhaka',      'area' => 'BSEC',          'openingBalance' => 0,     'businessId' => $bid],
            ['name' => 'Ahmed IT Center',     'mail' => 'ahmedit@center.com',        'mobile' => '0323-7004004', 'country' => 'Bangladesh', 'state' => 'Sylhet',     'city' => 'Sylhet',     'area' => 'Chouhatta',     'openingBalance' => 4000,  'businessId' => $bid],
            ['name' => 'Smart Office Systems','mail' => 'smartoffice@systems.com',   'mobile' => '0323-7005005', 'country' => 'Bangladesh', 'state' => 'Chattogram', 'city' => 'Chattogram', 'area' => 'GEC Circle',    'openingBalance' => 0,     'businessId' => $bid],
        ];
        ...
        // ── Products ─────────────────────────────────────────────────────────
        $products = [
            ['name' => 'Intel Core i5-12400F',          'brand' => $brand('Intel'),        'category' => $cat('Processors'),         'unitName' => $unit('Piece'), 'quantity' => '2',  'details' => '6 Cores/12 Threads, 2.5GHz Base, 4.4GHz Boost, LGA1700',          'barCode' => 'INT-I5-12400F-001',  'businessId' => $bid, 'stock' => 12, 'buy' => 20000, 'sell' => 25000],
            ['name' => 'AMD Ryzen 5 5600G',             'brand' => $brand('AMD'),          'category' => $cat('Processors'),         'unitName' => $unit('Piece'), 'quantity' => '2',  'details' => '6 Cores/12 Threads, 3.9GHz Base, Radeon Vega 7 Integrated GPU',   'barCode' => 'AMD-R5-5600G-001',   'businessId' => $bid, 'stock' => 10, 'buy' => 18000, 'sell' => 22500],
            ['name' => 'ASUS Prime B660M-K Motherboard','brand' => $brand('ASUS'),         'category' => $cat('Motherboards'),       'unitName' => $unit('Piece'), 'quantity' => '2',  'details' => 'LGA1700, DDR4, PCIe 4.0, USB 3.2, Micro-ATX',                     'barCode' => 'ASU-B660MK-001',     'businessId' => $bid, 'stock' => 8,  'buy' => 14000, 'sell' => 18000],
            ['name' => 'Kingston 8GB DDR4 3200MHz',     'brand' => $brand('Kingston'),     'category' => $cat('RAM'),                'unitName' => $unit('Piece'), 'quantity' => '5',  'details' => 'ValueRAM 8GB DDR4 3200MHz CL22 DIMM Desktop Memory',               'barCode' => 'KNG-DDR4-8G-001',    'businessId' => $bid, 'stock' => 30, 'buy' =>  3500, 'sell' =>  4800],
            ['name' => 'Seagate 1TB Barracuda HDD',     'brand' => $brand('Seagate'),      'category' => $cat('Storage (HDD/SSD)'), 'unitName' => $unit('Piece'), 'quantity' => '3',  'details' => '1TB 7200RPM 3.5" SATA III Internal Hard Drive',                    'barCode' => 'SEA-1TB-BRC-001',    'businessId' => $bid, 'stock' => 20, 'buy' =>  5000, 'sell' =>  6500],
            ['name' => 'WD 480GB Green SSD',            'brand' => $brand('WD'),           'category' => $cat('Storage (HDD/SSD)'), 'unitName' => $unit('Piece'), 'quantity' => '3',  'details' => '480GB 2.5" SATA SSD, 545MB/s Read Speed',                          'barCode' => 'WD-480-GRN-001',     'businessId' => $bid, 'stock' => 18, 'buy' =>  4200, 'sell' =>  5800],
            ['name' => 'TP-Link Archer C6 Router',      'brand' => $brand('TP-Link'),      'category' => $cat('Networking Equipment'),'unitName' => $unit('Piece'),'quantity' => '3',  'details' => 'AC1200 Dual Band Wi-Fi Router, 4x LAN, 1x WAN',                    'barCode' => 'TPL-C6-001',         'businessId' => $bid, 'stock' => 15, 'buy' =>  2200, 'sell' =>  3500],
            ['name' => 'Corsair CV650 650W PSU',        'brand' => $brand('Corsair'),      'category' => $cat('Power Supplies'),    'unitName' => $unit('Piece'), 'quantity' => '2',  'details' => '650W 80+ Bronze ATX Power Supply, Single Rail',                     'barCode' => 'CRS-CV650-001',      'businessId' => $bid, 'stock' => 12, 'buy' =>  5500, 'sell' =>  7200],
            ['name' => 'Logitech G102 Gaming Mouse',    'brand' => $brand('Logitech'),     'category' => $cat('PC Peripherals'),    'unitName' => $unit('Piece'), 'quantity' => '5',  'details' => 'Wired Gaming Mouse, 200–8000 DPI, RGB, 6 Buttons',                 'barCode' => 'LOG-G102-001',       'businessId' => $bid, 'stock' => 25, 'buy' =>  1400, 'sell' =>  2000],
            ['name' => 'Mechanical Keyboard Blue Switch','brand' => $brand('Generic'),     'category' => $cat('PC Peripherals'),    'unitName' => $unit('Piece'), 'quantity' => '3',  'details' => 'TKL 87-Key Mechanical Keyboard Blue Tactile Switch, RGB',           'barCode' => 'MK-BLUE-001',        'businessId' => $bid, 'stock' => 15, 'buy' =>  2000, 'sell' =>  3200],
            ['name' => 'Cooler Master Hyper 212 Black', 'brand' => $brand('Cooler Master'),'category' => $cat('CPU Cooling'),       'unitName' => $unit('Piece'), 'quantity' => '2',  'details' => 'CPU Air Cooler, 120mm PWM Fan, TDP 150W, Intel & AMD Compatible',   'barCode' => 'CM-212BLK-001',      'businessId' => $bid, 'stock' => 10, 'buy' =>  3000, 'sell' =>  4200],
            ['name' => '24" FHD Monitor 75Hz',          'brand' => $brand('Generic'),      'category' => $cat('Monitors'),          'unitName' => $unit('Piece'), 'quantity' => '2',  'details' => '24 Inch Full HD IPS Panel 75Hz, HDMI+VGA, Slim Bezel',             'barCode' => 'MON-24FHD-001',      'businessId' => $bid, 'stock' => 10, 'buy' => 14000, 'sell' => 18500],
        ];
        ...
        $purchases = [
            [
                ...
                'specialNote' => 'Intel i5-12400F initial stock', 'businessId' => $bid,
            ],
            [
                ...
                'specialNote' => 'Kingston RAM lot', 'businessId' => $bid,
            ],
            [
                ...
                'specialNote' => 'Seagate HDD batch – partial payment', 'businessId' => $bid,
            ],
            [
                ...
                'specialNote' => '24" FHD Monitors stock', 'businessId' => $bid,
            ],
            [
                ...
                'specialNote' => 'TP-Link router batch', 'businessId' => $bid,
            ],
        ];
        ...
        $sales = [
            ...
            [
                'header' => [
                    ...
                    'prevDue' => '7500', 'curDue' => '7500', 'status' => 'complete', 'businessId' => $bid,
                ],
                'items' => [
            ...
            [
                'header' => [
                    ...
                    'prevDue' => '4000', 'curDue' => '12300', 'status' => 'partial', 'businessId' => $bid,
                ],
                'items' => [
                    ['purchaseId' => $purId('PUR-COM-003'), 'qty' => 1, 'salePrice' => '6500', 'buyPrice' => '5000', 'totalSale' => '6500',  'totalPurchase' => '5000',  'profitTotal' => '1500', 'profitMargin' => '23.08', 'warranty_days' => '365'],
            ...
            [
                'header' => [
                    ...
                    'prevDue' => '0', 'curDue' => '17500', 'status' => 'due', 'businessId' => $bid,
                ],
                'items' => [[
