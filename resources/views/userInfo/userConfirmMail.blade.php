...
<!-- Mirrored from templates.iqonic.design/posdash/html/backend/auth-confirm-mail.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 08:08:13 GMT -->
<head>
    <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
      <title>{{ $config->count() > 0 ? ($config[0]->businessName ?? 'Retail Nova') : 'Retail Nova' }} | Confirm Mail</title>
                     ...
                     <div class="card-body p-0">
                        <div class="d-flex align-items-center auth-content">
                           <div class="col-lg-7 align-self-center">
                              <div class="p-3">
                                 <img src="{{asset('/public/eshop/')}}/assets/images/login/mail.png" class="img-fluid" width="80" alt="">
                                 ...
                                 <div class="d-inline-block w-100">
                                    <a href="{{route('userLogin')}}" class="btn btn-primary mt-3">Back to Home</a>
                                 </div>
                              </div>
                           </div>
...
<!-- Mirrored from templates.iqonic.design/posdash/html/backend/auth-confirm-mail.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 08:08:14 GMT -->
</html>