                              ...
                              <div class="p-3">
                                <div class="row">
                                 ...
                                 <h6 class="mb-2">Setup Your Business</h6>
                                    ...
                                    <button type="submit" class="btn btn-warning btn-sm">Skip For Now</button>
                                    </div>
                                </div>
                                 <form>
                                    <div class="row">
                                       <div class="col-lg-12">
                                          <div class="floating-label form-group">
                                             <input class="floating-input form-control" type="text" id="busName" name="busName" placeholder=" ">
                                             <label>Business Name</label>
                                          </div>
                                       </div>
                                       <div class="col-lg-12">
                                          <div class="floating-label form-group">
                                             <input class="floating-input form-control" type="text" id="number" name="number" placeholder=" ">
                                       ...
                                       <div class="col-lg-12">
                                          <div class="floating-label form-group">
                                             <input class="floating-input form-control" type="number" id="address" name="address" placeholder=" ">
                                             <label>Address</label>
                                          </div>
                                       </div>
                                       <div class="col-lg-12">
                                          <div class="floating-label form-group">
                                             <input class="floating-input form-control" type="number" id="website" name="website" placeholder=" ">
                                             <label>Website</label>
                                          </div>
                                       </div>
                                       <div class="col-lg-12">
