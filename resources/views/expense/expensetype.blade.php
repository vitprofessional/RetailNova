            ...
            <tr>
                ...
                <td>
                    <div class="d-flex list-action">
                        ...
                        <form action="{{ route('delExpense',['id'=>$expenseList->id]) }}" method="POST" style="display:inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="badge bg-warning mr-2" data-confirm="Are you sure to delete this expense type?" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" style="border:none; background:transparent; padding:0;"><i class="ri-delete-bin-line mr-0"></i>Delete</button>
                        </form>
                    </div>
                </td>
            </tr>
